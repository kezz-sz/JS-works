...
<div id="carrinho">
    <p id="ValorTotalConta"></p>
    <button onclick="Comprar()">Pagar</button>
    <button onclick="CarrinhoClose()">Fechar</button>
</div>
<div id="comprar">
...
<button class="carrinho" onclick="AbrirCarrinho()"><img src="https://cdn-icons-png.flaticon.com/512/8331/8331063.png" alt=""></button>
